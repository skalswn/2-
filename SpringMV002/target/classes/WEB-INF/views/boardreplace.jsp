...
<div class="container">
  ...
  <div class="panel panel-default">
   ...
   <form class="form-horizontal" action="${cpath}/boardreplace.do" method="post">
<%-- <form class="form-horizontal" action="<spring:url value='boardreplace.do'/>" method="post"> --%>
  <!--제목  -->
  ...
  <!--작성자  -->
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="writer" id="writer" value="${vo.writer}" readonly="readonly">
    </div>
  	</div>
  <!--내용 -->
  <div class="form-group">
  ...
  <div class="col-sm-10">
  <textarea class="form-control" rows="10" name="content" id="content">${vo.content}</textarea>
	</div>
	</div>
 <!--몰?루 -->	
  <!-- 	<div class="form-group">
